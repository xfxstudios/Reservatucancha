    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent siguiente = new Intent(acceso.this, MainActivity.class);
...
*/
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new CargarDatos().execute("http://10.0.2.2/CursoAndroid/registro.php?nombrez="+etNombres.getText().toString()+"&tele="+etTelefono.getText().toString());
